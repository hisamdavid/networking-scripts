...
def animation_function(i):
    ...
    #Clearing/refreshing the figure to avoid unnecessary overwriting for each new poll (every 8 seconds)
    subplot.clear()
    
    #Plotting the values in the list
    subplot.plot(x)

#Using the figure, the function and a polling interval of 8000 ms (8 seconds) to build the graph    
graph_animation = animation.FuncAnimation(figure, animation_function, interval = 8000)
